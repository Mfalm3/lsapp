...
<head>
    ...
    <style>
        .input-group-addon{background-color: orangered;color: white;}
            ...
            <ul class="nav">
                ...
                <li class="has-submenu">
                    <a href="#">
                        ...
                        <p>ORDERS RECORDS<span class="glyphicon glyphicon-chevron-right pull-right" style="padding-top: 8px" aria-hidden="true"></span></p>
                    </a>
                    <ul class="drp">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="drp">
                        ...
                        <li>
                            <a href="/sales/create"><span class="glyphicon glyphicon-plus pull-left" style="padding-top: 1px;padding-right: 10px;" aria-hidden="true"></span>
                                Add Sale
                            </a>
                        </li>
                        <li>
